...
const achievements: Achievement[] = [
  {
    ...
    title: "Top 30 Performer At IIC MAnipal 2024",
    colorClass: "text-yellow-600 dark:text-yellow-400",
  },
  {
    icon: <Medal className="h-6 w-6" />,
    title: "Finalist at Internal SIH - VIT Bhopal 2024 ",
    colorClass: "text-blue-600 dark:text-blue-400",
  },
  {
    icon: <Award className="h-6 w-6" />,
    title: "Top 10 Scholar at XII Boards",
    colorClass: "text-green-600 dark:text-green-400",
  },
  {
    icon: <Trophy className="h-6 w-6" />,
    title: "9.69 CGPA in Interim Semester at VIT Bhopal",
    colorClass: "text-purple-600 dark:text-purple-400",
  },
  {
    icon: <BookOpen className="h-6 w-6" />,
    title: "Finalist at BashCraft's Zerodha Financial Hackathon 2023",
